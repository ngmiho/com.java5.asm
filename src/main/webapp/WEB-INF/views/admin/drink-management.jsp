		...
		<div class="templatemo-content-widget white-bg col-2">
			...
			<div class="templatemo-content-widget white-bg col-2">
				<div class="col-1">
					...
					<br><br>					
					<form:form action="/admin/user" method="post" modelAttribute="drink" class="form-horizontal templatemo-container"
					  role="form">
					  <i class="fa fa-times"></i>
					  <div class="media margin-bottom-30">
					    <div class="media-left padding-right-25">
					      <a href="#"> <img class="media-object img-circle templatemo-img-bordered" src="images/person.jpg" alt="Sunset">
					      </a>
					    </div>
