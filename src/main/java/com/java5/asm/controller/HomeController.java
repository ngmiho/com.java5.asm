...
public class HomeController {
	...
	public String rqSignUp(@Valid @ModelAttribute("account") Account account, BindingResult result, Model model) {
		if (result.hasErrors()) {
			model.addAttribute("message", "Invalid information!");
		} else {
			model.addAttribute("message", "Valid information!");
	...
	public String rqForgotPassword(@Valid @ModelAttribute("account") Account account, BindingResult result,
			Model model) {
		if (result.hasErrors()) {
			model.addAttribute("message", "Invalid information!");
		} else {
	...
	public String postConfirmOTP(@Valid @ModelAttribute("account") Account account, BindingResult result, Model model) {
		return "login";
	}

	@RequestMapping("/change-password")
	public String rqChangePassword(@Valid @ModelAttribute("account") Account account, BindingResult result,
			Model model) {
		if (result.hasErrors()) {
			model.addAttribute("message", "Invalid information!");
		} else {
